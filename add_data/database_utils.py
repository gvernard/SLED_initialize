...
def upload_imaging_to_db_direct(datalist, username):
    ...
    for data in datalist:
        ...
        if 'date_taken' in finaldata.keys():
            imaging.date_taken = make_aware( datetime.datetime.fromisoformat(datetime.strptime(finaldata['date_taken'])) )
        imaging.save()
...
def upload_spectrum_to_db_direct(datalist, username):
    ...
    for data in datalist:
        ...
        if 'date_taken' in finaldata.keys():
            spectrum.date_taken = make_aware( datetime.datetime.fromisoformat(datetime.strptime(finaldata['date_taken'])) )
        else:
...
def upload_catalogue_to_db_direct(datalist, username):
    ...
    for data in datalist:
        ...
        if 'date_taken' in finaldata.keys():
            catalogue.date_taken = make_aware( datetime.datetime.fromisoformat(datetime.strptime(finaldata['date_taken'])) )
        else:
            #we apparently made the date taken a NOT_NULL field
